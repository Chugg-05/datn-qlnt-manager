...
public enum ErrorCode {
    NO_DATA(200, "No data available", HttpStatus.OK),
    ...
    INVALID_PASSWORD(400, "Your passwod mrust be at least {min} characters.", HttpStatus.BAD_REQUEST),
    ...
    BUILDING_ID_REQUIRED(400, "Building ID can not be balnk", HttpStatus.BAD_REQUEST),
